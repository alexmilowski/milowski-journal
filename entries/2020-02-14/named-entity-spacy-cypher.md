...
published: 2020-02-14T15:00:00-08:00
updated: 2020-02-14T15:00:00-08:00
keywords:
- python
- Spacy
...
content: |
  ...
  This is a kind of NLP task where various terms are identified by their part of speech
  and role within the sentences. Over the years, this process have evolved to
  a specific task of Named Entity Recognition and Resolution.
  ...
  is straightforward and then you just tell spacy to load the model with a
  single line of code. This returns a function that you can apply
  ...
  between entities. For example, for entities found at least twice, the following
  entities are connected:

  <img src='entities-min-count-2.png' width='100%'/>

  If you include all the entities detected, you get the following graph. My favourite
  discoveries are entities *Google Scrooge* and *International Talk Like a Pirate Day*.

  <img src='entities-min-count-1.png' width='100%'/>
